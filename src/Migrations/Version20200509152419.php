 ...
 */
final class Version20200509152419 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE Trajet (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, villedep VARCHAR(255) NOT NULL, datedep DATE NOT NULL, heuredep TIME NOT NULL, ville_a VARCHAR(255) NOT NULL, heure_a TIME NOT NULL, nbre_place INT NOT NULL, price DOUBLE PRECISION NOT NULL, distance INT NOT NULL, date_ajout DATE NOT NULL, INDEX IDX_2CF7ACBAA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE users (id INT AUTO_INCREMENT NOT NULL, users_id INT DEFAULT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, telephone VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, adresse VARCHAR(255) NOT NULL, ville VARCHAR(255) NOT NULL, cp INT NOT NULL, date_ins DATE NOT NULL, email VARCHAR(255) NOT NULL, INDEX IDX_1483A5E967B3B43D (users_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
